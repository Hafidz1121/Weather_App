...
class _HomePageState extends State<HomePage> {
  ...
  static String apiKey = "78eee7a3691b43dd8d244220231207";
  ...
  void fetchWeatherData(String searchText) async {
    try {
      ...
      setState(() {
        ...
        var newDate = DateFormat("dd MMMM yyyy").format(parseDate);
        currentDate = newDate;
  ...
  // function to handle first two name of string location
                                            ...
                                            children: [
                                              ...
                                              TextField(
                                                ...
                                                decoration: InputDecoration(
                                                  ...
                                                  hintText: 'Search city e.g. Indonesia',
